...
const CONFIG = {
  ...
  allowedResources: [-1002808281023, -1002644865624, -1002598164499, -1003847757739, -1002456647088],
...
export function startShigiBot() {
 ...
 const auctionManager = new AuctionManager(
    ...
    "./shigi_auctions.json",
    {
      ...
      notReplyToLast: "Упс! Ставку потрібно робити реплаєм виключно на ОСТАННЮ актуальну ставку в чаті! ⚠️", // ДОДАЛИ ЦЕЙ РЯДОК
      tooSmall: (min) => `Ставка замала! Мінімальна наступна: ${min}`,
      late: "Аукціон вже закінчився, ви трошки запізнилися 🙏",
      lateNoBids: "Аукціон закінчився! Радий бачити стільки активності, дякую всім учасникам! Слідкуйте за наступними аукціонами, буде ще багато цікавого! 🥳",
      extended: "⏳ Ставка в останні хвилини! Час аукціону продовжено на 30 хв.",
      editWarn: "Аяяй, я все бачу! Редагувати ставки заборонено 😏",
      bidDeletedReply: "Йой... Хтось видалив минулу ставку, відповідай на останню.",
      editLog: (old, newVal, link) => `🚨 <b>Редагування ставки!</b>\nБуло: ${old}\nСтало: ${newVal}\n<a href="${link}">Посилання</a>`,
      deleteLog: (val, link) => `🗑 <b>Видалення ставки!</b>\nСума: ${val}\n<a href="${link}">Посилання</a>`
    },
    CONFIG.adminChatId
);
  ...
  bot.hears(/^ти\s+любиш\s+(маму|тата)[!?.]*$/i, async (ctx) => {
  const replyText = "Звісно я люблю! (Не виганяйте мене на вулицю)";
