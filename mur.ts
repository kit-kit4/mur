...
// 3. Команда Мур
  bot.hears(/^[Мм]ур[!?.]*$/i, async (ctx) => {
    await ctx.reply(
      "<b>Хальо, няв няв.🐾 Ось основне по Матурі 2026:</b>\n\n" +
      "🎓 <b>Головне правило:</b> Треба здати 3 обов'язкові предмети на 30% + обрати 1 предмет на розширеному рівні (поріг 0%).\n\n" +
      "--- 🧮 <b>МАТЕМАТИКА (Basics)</b> ---\n" +
      "• <b>Числа:</b> Відсотки, логарифми, степені.\n" +
      "• <b>Алгебра:</b> Квадратні рівняння, розкладання на множники.\n" +
      "• <b>Функції:</b> Читання графіків, параболи.\n" +
      "• <b>Прогресії:</b> Арифметична та геометрична (будуть 100%).\n" +
      "• <b>Тригонометрія:</b> Синуси/косинуси в трикутнику.\n" +
      "• <b>Ймовірність:</b> Кубики, кульки, середнє значення.\n" +
      "<i>💡 Порада: На екзамені дають книжечку з формулами — вивчи, де що лежить.</i>\n\n" +
      "--- 🇵🇱 <b>ПОЛЬСЬКА МОВА</b> ---\n" +
      "• <b>Тест:</b> Робота з текстом та знання мовних нюансів.\n" +
      "• <b>Lektury (Твори):</b> Треба знати зміст «Pan Tadeusz», «Dziady III», «Lalka», «Wesele».\n" +
      "• <b>Твір:</b> Мінімум 300 слів. Треба вміти доводити свою думку на прикладах з книг.\n" +
      "• <b>Усна частина:</b> 2 питання (одне за списком творів, друге — по картинці або тексту).\n\n" +
      "--- 🇬🇧 <b>АНГЛІЙСЬКА МОВА</b> ---\n" +
      "• <b>Listening:</b> Слухання діалогів.\n" +
      "• <b>Reading:</b> Робота з пропусками в текстах.\n" +
      "• <b>Writing:</b> Написати імейл або пост у блог (80-130 слів).\n" +
      "• <b>Grammar:</b> Present/Past/Future Perfect, Passive Voice.\n\n" +
      "--- 📌 <b>ПОРАДА ВІД МЕНТОРА</b> ---\n" +
      "Саш, не намагайся вивчити все за раз. Почни з <b>arkusze</b> (тестів) минулих років. Математика там майже завжди однакова, просто цифри міняють.\n\n" +
      "<i>Зберись, не відволікайся на меми, поки не пройдеш хоча б один тест!</i> 🚀",
      { 
        parse_mode: "HTML",
